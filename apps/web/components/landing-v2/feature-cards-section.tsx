    ...
    illustration: (
      ...
      >
        <svg viewBox="0 0 336 260" className="w-full h-full" aria-label="Architecture dependency graph">
          ...
          <g>
            <rect x="36" y="112" width="56" height="36" rx="8" fill="#18181b" stroke="#3b82f6" strokeOpacity="0.6" />
            <circle cx="52" cy="130" r="3" fill="#60a5fa" />
    ...
    illustration: (
      <div className="relative w-full overflow-hidden" style={{ height: "260px" }}>
        <svg viewBox="0 0 336 260" className="w-full h-full" aria-label="Security scanning radar">
          ...
          <line x1="168" y1="130" x2="272" y2="130" stroke="#3b82f6" strokeOpacity="0.7" strokeWidth="1.5" />
          <circle cx="168" cy="130" r="3.5" fill="#60a5fa" />
    ...
    illustration: (
      <div className="relative w-full overflow-hidden px-6 pt-8" style={{ height: "260px" }}>
        <div className="rounded-lg border border-zinc-800 bg-zinc-950/90 p-3.5 font-mono text-[10.5px] leading-5" aria-label="Suggested code fix">
          ...
          <div className="rounded bg-blue-500/15 px-1.5 text-blue-300">+ db.raw(`... ?`, [id])</div>
          <div className="mt-2 text-zinc-600">// parameterized — injection closed</div>
          <div className="mt-3 inline-flex items-center gap-1.5 rounded-md border border-blue-500/25 bg-blue-500/10 px-2 py-1 text-blue-300">
...
export function FeatureCardsSection() {
  return (
    <div className="relative z-20 py-40 overflow-hidden" style={{ backgroundColor: "#09090B" }}>
      {/* soft blue ambience behind the card row */}
      <div
      ...
      <div className="relative w-full flex justify-center px-6">
        <div className="w-full max-w-5xl">
          ...
          {/* Feature cards — text on top, visual below, blue bleed from the
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {featureCards.map((card, index) => (
              <motion.a
                ...
                className="group relative flex flex-col overflow-hidden border border-zinc-800 bg-zinc-950 transition-all hover:border-blue-500/40 hover:shadow-[0_16px_56px_-16px_rgba(37,99,235,0.45)]"
              ...
              >
                ...
                {/* blue gradient bleeding up from the bottom edge */}
                <div
                  className="pointer-events-none absolute inset-x-0 bottom-0 h-48 transition-opacity group-hover:opacity-100 opacity-80"
                  style={{
                    background:
                      "linear-gradient(to top, rgba(37, 99, 235, 0.42) 0%, rgba(29, 78, 216, 0.16) 45%, transparent 100%)",
                  }}
                />
              </motion.a>
            ))}
