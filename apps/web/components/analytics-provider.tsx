 ...
 * no env keys this renders nothing and the app is unaffected. Once configured,
 * the shared track() helper starts flowing to PostHog automatically.
 */
