...
export const SOLUTIONS: Record<string, SolutionContent> = {
  ...
  founders: {
    ...
    title: 'Understand your risk without a security team',
    lead: 'See which parts of your product could break, which are business-critical, and a risk posture that trends as you improve — without hiring a security team.',
    hero: 'simulation',
    problems: [
      { title: 'Risk is abstract', desc: 'You can’t tell the board which parts of the product are actually fragile.' },
      { title: 'Hidden single points of failure', desc: 'One component could take the whole product down with it.' },
    ...
    journey: [
      ...
      { title: 'See the blast radius', desc: 'Simulate outages and see which services fail and which paths break.' },
    ...
    outcomes: [
      { stat: '1 posture', label: 'security, reliability, architecture & AI in one score' },
      { stat: 'Every commit', label: 'analysed against your architecture' },
